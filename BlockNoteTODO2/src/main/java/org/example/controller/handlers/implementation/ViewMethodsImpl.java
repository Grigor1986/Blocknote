...
import org.example.controller.handlers.implementation.ViewMethods;
...
public class ViewMethodsImpl implements ViewMethods {
    ...
    public void startProgram() throws IOException, InterruptedException {
        outputView.outputView(Messages.STARTMESSAGE.getValue().formatted(Messages.OUTPUTMESSAGEALLTASKS.getValue()
